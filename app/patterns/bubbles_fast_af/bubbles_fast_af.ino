...
const float BUBBLE_GAP    = 5.2f;   // @knob 0.2 8 0.05 group:Overlap "Seconds between bubbles"
const float RAMP_TIME     = 3.5f;   // @knob 0.5 12 0.1 group:Speed "Bubble growth time (s)"
const float HOLD_TIME     = 0.35f;   // @knob 0 4 0.05 group:Speed "Hold at full before popping (s)"
const float RIPPLE_BRIGHT = 0.06f;   // @knob 0 1 0.01 group:Shape "Ripple brightness"

// --- shaping ------------------------------------------------------------
const float GROW_EXP      = 4.5f;    // @knob 1 6 0.1 group:Shape "Growth curve exponent (2 = quadratic)"
...
const float RIPPLE_REACH  = 31.0f;   // @knob 10 75 1 group:Shape "Ripple fade-out radius (in)"
